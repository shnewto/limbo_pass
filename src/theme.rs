...
use crate::{assets::AudioAssets, fsm::Fsm};
...
impl Plugin for ThemePlugin {
    fn build(&self, app: &mut App) {
        ...
        .add_system_set(SystemSet::on_enter(Fsm::Running).with_system(start));
    }
}

fn start(audio: Res<Audio>, audio_assets: ResMut<AudioAssets>) {
